export default function FaviconMetaTags() {
  return (
    <>
      ...
      <link rel="manifest" href="/assets/manifest.json" /> <meta name="mobile-web-app-capable" content="yes" />{" "}
      <meta name="theme-color" content="#171717" /> <meta name="application-name" content="Apsyadira" />{" "}
      ...
      <meta name="apple-mobile-web-app-title" content="Apsyadira" />{" "}
      <link
